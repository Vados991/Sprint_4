...
public class MainPage {
    ...
    public static By answerFourth = By.id("accord121ion__panel-3"); //Ответ на вопрос №4
    public static By answerFifth = By.id("accordion__panel-4");  //Ответ на вопрос №5
    ...
    public void openMainPage() {
        driver.get(urlHomePage); //метод открыть страницу
    }
    ...
    public void clickCookie() {
        driver.findElement(cookieButton).click(); //проскролить до заголовка Вопросы о важном
    }

    public void clickQuestion(By question) {
        driver.findElement(question).click();     //кликнуть на принятие куки
    }

    public String getAnswerText(By answer) {
        return driver.findElement(answer).getText(); //нажать на вопрос
    }

    public void clickOrderButton(By orderButton) {
        driver.findElement(orderButton).click();    //посмотреть текст ответа на вопрос
